...
### Победа
[Смотреть запись победы](progression-win.cast)
### Поражение
[Смотреть запись поражения](progression-lose.cast)


## Запуск игры "Простое ли число?"

### Победа
[Смотреть запись победы](prime-win.cast)
### Поражение
[Смотреть запись поражения](prime-lose.cast)
