...
### Победа
[Смотреть запись победы](calc-win.cast)
### Поражение
[Смотреть запись поражения](calc-lose.cast)

## Запуск игры "НОД"

### Победа
[Смотреть запись победы](gcd-win.cast)
### Поражение
[Смотреть запись поражения](gcd-lose.cast)